...
public class LeftDiagonal{
    ...
    public LeftDiagonal(int radius, double angle, double nX, double nY){
        ...
        if(Math.PI/2>angle){
            triangleSup = case1Sup(height, baseLenght, angle, nX, nY);
            triangleInf = case1Inf(height, baseLenght, angle, nX, nY);
        }
        else if(Math.PI<angle && Math.PI*3/2>angle){
            angle = angle - Math.PI;
    ...
    public Triangle case1Sup(double height, double baseLenght, double angle, double nX, double nY){
        nX = nX + baseLenght/2;
        nY = nY - height;
    ...
    public Triangle case1Inf(double height, double baseLenght, double angle, double nX, double nY){
        nX = nX + baseLenght/2;
        nY = nY - height;
